...
$formp1sql = "select p.* from product_category1 as p where p.product_category2_id = (select id from Product_category2 where name ='Eye') "; 
...
if (isset($_POST['submit'])) {
    ...
    $filteredSql = "SELECT p.*, p1.name AS pname, b.name AS bname 
                    ...
                    WHERE p1.product_category2_id = (select id from product_category2 where name = 'Eye')"; 
...
$plainsql = "select p.*,p1.name as pname,b.name as bname from product as p join product_category1 as p1 on p.product_category1_id = p1.id join brand_category as b on p.brand_id = b.id where p1.product_category2_id = (select id from product_category2 where name = 'Eye')";
...
<div class="mainImage">
    ...
    <div class="itemsSection">
        <ul>
            ...
            <li><a href="shopByConsernEye.php" class="navactive">Eye</a></li>
