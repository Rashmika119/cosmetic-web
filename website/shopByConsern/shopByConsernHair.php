...
$formp1sql = "select p.* from product_category1 as p where p.product_category2_id = (select id from Product_category2 where name ='Hair') "; 
...
if (isset($_POST['submit'])) {
    ...
    $filteredSql = "SELECT p.*, p1.name AS pname, b.name AS bname 
                    ...
                    WHERE p1.product_category2_id = (select id from product_category2 where name = 'Hair')"; 
...
$plainsql = "select p.*,p1.name as pname,b.name as bname from product as p join product_category1 as p1 on p.product_category1_id = p1.id join brand_category as b on p.brand_id = b.id where p1.product_category2_id = (select id from product_category2 where name = 'Hair')";
...
<div class="mainImage">
        ...
        <h1>SHOP</h1>
        <h3>Shop by Consern > Hair</h3>
        <img src="images/pic2.png" alt="" class="pic">
    </div>

    <div class="itemsSection">
        <ul>
            <li ><a href="shopByConsernHair.php" class="navactive" >Hair</a></li>
            ...
            <li><a href="shopByConsernBody.php">Body</a></li>
        </ul>
    </div>
    ...
    <button type="submit" name="submit" class="submitbutton">Submit</button>
        ...
        <div class="itemSection">
            <?php $results = count($plainsqlresultdata) ;?>
              <p id="resultAmount">Showing <?php echo $results;?> results</p>
              <div class="itemGroup">
