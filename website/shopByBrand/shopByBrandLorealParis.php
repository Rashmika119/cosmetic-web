...
if (isset($_POST['submit'])) {
    ...
    ON p.brand_id = b.id 
    WHERE p.brand_id = (SELECT id FROM brand_category WHERE name = 'Loreal Paris')
    ";
...
<div class="mainImage">
    ...
    <h1>SHOP</h1>
    <h3>Shop by Brand > Loreal Paris</h3>
...
<div class="itemsSection">
    <ul>
        ...
        <li><a href="shopByBrandLorealParis.php" class="navactive">Loreal Paris</a></li>
        <li><a href="shopByBrandNeutrogena.php">Neutrogena</a></li>
        <li><a href="shopByBrandCeraVe.php">Cerave</a></li>
    </ul>
</div>
