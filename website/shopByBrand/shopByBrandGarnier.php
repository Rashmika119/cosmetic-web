...
ON p.brand_id = b.id 
WHERE p.brand_id = (SELECT id FROM brand_category WHERE name = 'Garnier')";
...
<div class="mainImage">
    ...
    <h1>SHOP</h1>
    <h3>Shop by Brand > Garnier</h3>
    <img src="images/pic2.png" alt="" class="pic">
</div>

<div class="itemsSection">
    <ul>
        <li><a href="shopByBrandGarnier.php" class="navactive">Garnier</a></li>
