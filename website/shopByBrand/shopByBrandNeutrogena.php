...
ON p.brand_id = b.id 
WHERE p.brand_id = (SELECT id FROM brand_category WHERE name = 'Neutrogena')";
...
<div class="mainImage">
    ...
    <h1>SHOP</h1>
    <h3>Shop by Brand > Neutrogena</h3>
...
<div class="itemsSection">
    <ul>
        ...
        <li><a href="shopByBrandNeutrogena.php" class="navactive">Neutrogena</a></li>
